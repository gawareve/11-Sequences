...
def run_test_count_items_bigger_than():
    ...
    sequence = [45, 84, 32, 70, -10, 40,-9,0]
    threshold = -10.000000001
    expected = 8
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    expected = 1
    actual = count_positive_sines([6, 6, 6, 6, 6, 6, 6, 6, 6,6,7])
    print()
...
def run_test_sum_first_n():
    ...
    expected = 20
    actual = sum_first_n([5,5,5,5,5,5], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)

    expected = 6
    actual = sum_first_n([6,6,6,6,6,6,6],1)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
